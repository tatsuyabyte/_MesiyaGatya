...
{
    private const string STATIC_MAP_URL = "https://maps.googleapis.com/maps/api/staticmap?key=${Places}&zoom=15&size=640x640&scale=2&maptype=terrain&style=element:labels|visibility:off";// Google Maps Static API URL、${APIKey}を作成したapiキーに書き換える
